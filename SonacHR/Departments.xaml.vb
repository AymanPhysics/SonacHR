...
Public Class Departments
    Public TableName As String = "Departments"
    ...
    Public Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        End If
        bm.Fields = New String() {SubId, SubName, "Shift1", "Shift2", "Shift3", "Shift0"}
        bm.control = New Control() {txtID, txtName, Shift1, Shift2, Shift3, Shift0}
    ...
    Private Sub txtID_KeyPress2(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles Shift0.KeyDown, Shift1.KeyDown, Shift2.KeyDown, Shift3.KeyDown
