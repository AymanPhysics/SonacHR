...
Public Class LeaveRequests
    ...
    Private Sub DayDate_LostFocus(sender As Object, e As RoutedEventArgs) Handles DayDate.LostFocus
        ...
        Dim dt As DataTable = bm.ExecuteAdapter("select 2 NoofMonthlyExecuses,dbo.GetEmpLeaveBal(Id,'" & bm.ToStrDate(DayDate.SelectedDate) & "') Used from Employees where Id=" & EmpId.Text.Trim())
        If dt.Rows.Count > 0 Then
            Bal.Text = Val(dt.Rows(0)("NoofMonthlyExecuses").ToString)
